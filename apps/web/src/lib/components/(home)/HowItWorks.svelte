	...
	<div class="relative mt-6 w-full sm:mt-12">
		...
		<div class="grid gap-6">
			{#each steps as step, index (step.number)}
				<div class="relative grid gap-4 sm:grid-cols-[1fr_auto_1fr] sm:items-start sm:gap-6">
					<div
						class={index % 2 === 0
					...
					<div
						class="absolute top-0 left-5 grid size-3 -translate-x-1/2 place-items-center rounded-full border border-border bg-background sm:left-1/2 sm:-translate-x-1/2"
					>
