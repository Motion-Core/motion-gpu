...
<main class="flex h-dvh min-h-0 flex-col overflow-hidden">
	<div class="flex h-9 items-center justify-between border-b border-border bg-card px-2 sm:px-3">
		<div
			class="inline-flex items-center gap-1 py-2 text-sm tracking-tight text-foreground transition-colors hover:text-foreground focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-background focus-visible:outline-none"
		>
			<a
				href={resolve('/' as const)}
				class="inline-flex items-center gap-1 py-1.5 text-xs tracking-tight text-foreground-muted transition-colors hover:text-foreground focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-background focus-visible:outline-none"
