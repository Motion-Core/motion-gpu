...
//
import { FragCanvas, ShaderPass, defineMaterial } from '@motion-core/motion-gpu/react';
...
export default function App() {
	return <FragCanvas material={material} passes={passes} outputColorSpace="linear" />;
}
