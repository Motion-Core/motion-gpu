...
.motiongpu-error-overlay {
	...
	--motiongpu-guide-duotone-glint: oklch(from var(--motiongpu-shadow-highlight-color) l c h / 0.08);
	...
	--motiongpu-radius-dialog-inner: calc(var(--motiongpu-radius-xl) - var(--motiongpu-surface-gap));
	--motiongpu-radius-surface-inner: calc(var(--motiongpu-radius-lg) - var(--motiongpu-surface-gap));
...
.motiongpu-error-source-snippet {
	...
	background: var(--motiongpu-color-background-mute);
	box-shadow: var(--motiongpu-shadow-md);
}
