...
import { FragCanvas, defineMaterial, useFrame, useSpektral } from '../../../src/lib/react';
...
fn frag(uv: vec2f) -> vec4f {
	return vec4f(spektralUniforms.brightness * uv.x, 0.1, 0.2, 1.0);
}
`,
	uniforms: {
		brightness: 0.5
...
const materialAlternate = defineMaterial({
	fragment: `
fn frag(uv: vec2f) -> vec4f {
	return vec4f(0.1, spektralUniforms.brightness * uv.y, 0.8, 1.0);
}
`,
	uniforms: {
		brightness: 0.5
