...
/**
 * Creates a test Spektral context with pluggable render mode and frame-control spies.
 */
...
/**
 * Wraps tested UI with Spektral context provider.
 */
function withProvider(ui: ReactElement, payload: { context: SpektralContext }): ReactElement {
	return (
